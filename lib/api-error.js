...
// Backend bir vaqtning o'zida ikkala shaklni beradi (backend javobi, 10-band):
//   { "email": "Укажите корректный адрес почты",
//     "errors": [{ "loc": ["email"], "msg": "…", "type": "value_error" }] }
// Tekis xarita ustunroq, `errors` esa qolgan bo'shliqlarni to'ldiradi.
function fieldErrors(details) {
    ...
    if (Array.isArray(details.errors)) {
        for (const e of details.errors) {
            ...
            // Eski javoblarda `loc` «body» bilan boshlanadi, yangisida — yo'q.
