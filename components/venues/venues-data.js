...
export const VENUES_FAQ = [
    {
        ...
        a: 'Портрет, каталог, реклама или съёмка контента — от этого зависят площадь зала, высота потолков и набор оборудования. Выберите нужное в фильтре «Тип проекта».',
    },
    {
        q: 'Обсудите детали',
        a: 'Напишите площадке в чате платформы: дата, время, количество человек и нужное оборудование. Все договорённости остаются в переписке.',
    },
    {
        q: 'Изучите фотографии',
        a: 'В карточке площадки есть фотографии по залам, характеристики, оснащение и отзывы арендаторов — этого достаточно, чтобы оценить пространство.',
    },
    {
        q: 'Что входит в стоимость аренды?',
        a: 'Обычно это аренда зала и базовое оборудование студии. Точные условия и минимальное время аренды указаны в блоке «Стоимость».',
    },
]
