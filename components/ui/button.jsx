...
const VARIANTS = {
    ...
    goldStroke: 'bg-transparent text-gold border border-gold hover:bg-gold hover:text-white',
    white: 'bg-white text-black hover:bg-[#e6e6e6]',
    whiteStroke: 'bg-transparent text-white border border-white hover:bg-white hover:text-black',
    darkStroke: 'bg-transparent text-black border border-black/15 hover:border-black',
